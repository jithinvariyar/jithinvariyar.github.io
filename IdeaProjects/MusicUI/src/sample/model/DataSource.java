...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/home/jithin/Documents/IdeaProjects/Music_DB/" + DB_NAME;
    ...
    public static final String QUERY_ARTIST_SORT = " ORDER BY " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + " COLLATE NOCASE ";

    public static final String QUERY_ALBUM_BY_ARTIST_START = "SELECT " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME +
                                                              " FROM " + TABLE_ALBUMS + " JOIN " + TABLE_ARTISTS +
                                                              " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + "=" +
                                                              TABLE_ARTISTS + "." + COLUMN_ARTIST_ID + " WHERE " +
                                                              TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + "=" + "'";
    public static final String QUERY_ALBUM_BY_ARTIST_SORT = " ORDER BY " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + " COLLATE NOCASE";
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START = "SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME +
                                                              ...
                                                              " FROM " + TABLE_SONGS + " JOIN " + TABLE_ALBUMS + " ON " + TABLE_SONGS + "." + COLUMN_SONG_ALBUM + "=" + TABLE_ALBUMS + "." + COLUMN_ALBUM_ID +
                                                              " JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + "=" + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID +
    ...
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " + TABLE_ARTIST_SONG_VIEW +
                                                            ...
                                                            " FROM " + TABLE_SONGS + " JOIN " + TABLE_ALBUMS +
    ...
    public static final String QUERY_VIEW_SONG_INFO_PREP = "SELECT " + COLUMN_ARTIST_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK +
            " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = ?" + " COLLATE NOCASE";
    ...
    public static final String QUERY_SONG_OF_ALBUM = "SELECT * FROM " + TABLE_SONGS + " WHERE " + COLUMN_SONG_ALBUM + " = ? ORDER BY " + COLUMN_SONG_TITLE + " COLLATE NOCASE";
    ...
    private PreparedStatement querySongOfAlbum;
    ...
    public boolean open(){
        try{
            ...
            queryAlbumsByArtistId = conn.prepareStatement(QUERY_ALBUM_BY_ARTIST_ID);
            querySongOfAlbum = conn.prepareStatement(QUERY_SONG_OF_ALBUM);
            updateArtistName = conn.prepareStatement(UPDATE_ARTIST_NAME);
            return true;
        } catch(SQLException e){
            System.out.println("Can't create a connection: " + e.getMessage());
            return false;
        }
    }
    ...
    public void close(){
        try {
            ...
            if(querySongOfAlbum != null){
                querySongOfAlbum.close();
            }
    ...
    public List<Artist> queryArtists(int sortOrder){
        ...
        try(Statement statement = conn.createStatement();
           ...
           while (results.next()){
               ...
               String artistName = results.getString(INDEX_ARTIST_NAME);
               int artistID = results.getInt(INDEX_ARTIST_ID);
...
//        System.out.println(sb.toString());
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                System.out.println("Resetting default auto commit");
    ...
    public List<Song> querySongByAlbum(int albumId){
        try {
            querySongOfAlbum.setInt(1,albumId);
            ResultSet results = querySongOfAlbum.executeQuery();
